...
# Load the data
rawdata <- Read10X(data.dir = "filtered_feature_bc_matrix/")
...
The contribution of single PCs to the total variance in the data. This gives us information about how many PCs we should consider in order to compute the neighborhood relations of cells. Here I chose to use the first 6 PCs based on the variety of clusters.
